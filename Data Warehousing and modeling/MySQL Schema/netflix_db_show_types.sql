...
CREATE TABLE `show_types` (
  `Mapped_Type_ID` int NOT NULL,
  `Show_Type` varchar(10) NOT NULL,
  PRIMARY KEY (`Mapped_Type_ID`),
  UNIQUE KEY `Mapped_Type_ID_UNIQUE` (`Mapped_Type_ID`)
...
INSERT INTO `show_types` VALUES (0,'movie'),(1,'tv');
...
-- Dump completed on 2025-01-24  5:56:00
